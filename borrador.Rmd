...
Se realizó un estudio descriptivo de corte transversal  mediante el análisis de las  encuestas realizadas a los visitantes que ingresaron a Uruguay durante el periodo 2014-2015. Dichas encuestas fueron llevadas a cabo por agentes del Ministerio de Turismo del Uruguay. Inicialmente se pretendía la utilización de una serie temporal de mayor amplitud pero debido a que lasla encuesta fue modificada luego del año 2013 
...
```{r,fig.aline = "center", fig.height = 5, fig.width = 7,out.width = "6.5in",  fig.cap= "Gastos totales incurridos por turistas segun el mes durante el año 2015", echo=FALSE}
